...
public class n11Process {
	...
	public void testN11() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try { if ("".equals(selenium.getText("//div[@id='p-32812284']/div[2]/span[2]"))) break; } catch (Exception e) {}
			Thread.sleep(1000);
		}
		selenium.click("//div[@id='p-32812284']/div[2]/span[2]");
		...
		verifyEquals("Samsung Galaxy Alpha SM-G850 Cep Telefonu", selenium.getText("link=Samsung Galaxy Alpha SM-G850 Cep Telefonu"));
		...
		verifyFalse(selenium.isTextPresent("Samsung Galaxy Alpha SM-G850 Cep Telefonu"));
	}
